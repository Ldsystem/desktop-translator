...
export function createStudyApi(refreshPersonal: () => void): StudyApi {
  return {
    ...
    getVocabularyDetail: (entryId) => invoke<VocabularyDetail>("get_vocabulary_detail", { entryId }),
    refreshVocabularyMeanings: (entryId) => invoke<VocabularyDetail>("refresh_vocabulary_meanings", { entryId }),
    listFilteredRelated: (entryId, filter: RelatedFilter, offset, limit) => invoke<RelatedWordPage>("get_filtered_related_vocabulary", { entryId, filter, offset, limit }),
